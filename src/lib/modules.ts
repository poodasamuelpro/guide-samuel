...
export const BADGE_LABELS: Record<string, string> = {
  ...
  module_2: 'Acheteur averti',
  module_3: 'Expert logistique',
  module_4: 'Selectionneur pro',
