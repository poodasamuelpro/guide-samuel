  ...
  return (
    <div ref={ref} className="card p-6 shadow-sm">
      <div className="flex items-center gap-2 mb-2">
        <Plane size={18} className="text-[#8bd346]" />
        <h2 className="text-base font-bold text-[#073b4c]">Itinéraire de ta marchandise</h2>
      </div>
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 flex-wrap">
              <p className="text-sm font-bold text-[#073b4c]">{mode}</p>
      ...
      <div className="bg-[#073b4c] pt-6 pb-8">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <div>
              <p className="text-[10px] font-bold text-[#8bd346] uppercase tracking-widest">Module 03</p>
            ...
            {tabs.map((tab) => (
              <button
                ...
                className={`px-3 py-1.5 rounded-full text-xs font-semibold transition-all min-h-0 ${
                  activeTab === tab.id ? 'bg-[#8bd346] text-[#073b4c] font-bold' : 'bg-white/10 text-white/80 hover:bg-white/20'
                }`}
              >
                {tab.label}
              </button>
          ...
          <div className="space-y-6">
            ...
            <ScrollSection delay={0.05}>
              <div className="card p-6 shadow-sm">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h2 className="text-base font-bold text-[#073b4c]">Modes de livraison depuis la Chine</h2>
                </div>
                <DeliveryTable />
              </div>
            </ScrollSection>
            ...
            <ScrollSection delay={0.05}>
              <div className="card p-6 shadow-sm">
                <div className="flex items-center gap-2 mb-4">
                  <Plane size={18} className="text-[#8bd346]" />
                  <h2 className="text-base font-bold text-[#073b4c]">Transitaire — Pour les grosses commandes</h2>
                </div>
                ...
                {/* Route */}
                <div className="rounded-xl bg-[#eef9de] border border-[#8bd346]/30 p-4 mb-5">
                  <p className="text-xs font-bold text-[#073b4c] mb-2 flex items-center gap-1.5">
                    <MapPin size={13} className="text-[#8bd346]" /> Route typique : Chine → Burkina Faso
                  </p>
                  <div className="flex items-center gap-2 flex-wrap text-xs text-gray-600">
                    {['Guangzhou / Shenzhen', '→', 'Port Abidjan ou Lomé', '→', 'Ouagadougou (route)'].map((step, i) => (
                      <span key={i} className={step === '→' ? 'text-[#8bd346] font-bold' : 'bg-white rounded-lg px-2 py-1 border border-gray-100'}>
                        {step}
                      </span>
                    ))}
                  </div>
            ...
            <ScrollSection delay={0.05}>
              <div className="card p-6 shadow-sm">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h2 className="text-base font-bold text-[#073b4c]">Le CBM — Volume facturable en fret maritime</h2>
                </div>
                <p className="text-gray-600 text-sm leading-relaxed mb-4">
            ...
            <ScrollSection delay={0.05}>
              <div className="card p-6 shadow-sm">
                <div className="flex items-center gap-2 mb-4">
                  <FileText size={18} className="text-[#073b4c]" />
                  <h2 className="text-base font-bold text-[#073b4c]">Douane et taxes — Zone UEMOA</h2>
                </div>
                <p className="text-gray-600 text-sm leading-relaxed mb-4">
