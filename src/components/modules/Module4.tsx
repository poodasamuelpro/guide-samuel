  ...
  return (
    <div className="card p-6 shadow-sm">
      <div className="flex items-center gap-2 mb-2">
        ...
        <h2 className="text-base font-bold text-[#1a2a4a]">Jeu : Importer ou pas ?</h2>
      </div>
      ...
      {!gameOver ? (
          ...
          <div className="relative h-52 mb-5" style={{ touchAction: 'none' }}>
            ...
            >
              ...
              <div className="relative z-10 text-center">
                ...
                <p className="text-sm font-bold text-[#1a2a4a] leading-tight">{card.product}</p>
        ...
        >
          ...
          <p className="text-xl font-extrabold text-[#1a2a4a] mb-1">
          ...
          <button
            onClick={reset}
            className="flex items-center justify-center gap-2 px-6 py-2.5 rounded-xl bg-[#1a2a4a] text-white text-sm font-bold hover:bg-[#243d6a] transition-colors mx-auto"
          >
          ...
          <div className="space-y-6">
            ...
            <ScrollSection delay={0.05}>
              <div className="tip-box">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <p className="text-xs font-bold text-[#1a2a4a] mb-2">La méthode pour valider un produit</p>
                    <ul className="space-y-1.5 text-xs text-gray-700">
                      {[
                        ...
                        <li key={i} className="flex items-start gap-2">
                          <Star size={10} className="text-[#f2994a] shrink-0 mt-0.5" />
                          <span>{tip}</span>
                        </li>
                      ))}
                    </ul>
            ...
            <ScrollSection delay={0.05}>
              <div className="rounded-xl bg-[#1a2a4a] p-5 text-white">
                <p className="text-xs font-bold text-[#f2994a] uppercase tracking-widest mb-3">Produits populaires Burkina Faso 2025</p>
                  ...
                  {[
                    ...
                    <div key={name} className="flex items-center gap-2 p-2 rounded-xl bg-white/10">
                      ...
                      <div>
                        ...
                        {hot && <span className="text-[9px] text-[#f2994a]">Tendance</span>}
                      </div>
                    </div>
                  ))}
                </div>
