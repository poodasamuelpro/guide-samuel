    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#1a2a4a] to-[#0f1a2e] p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          <div className="w-20 h-20 bg-gradient-to-br from-[#1a2a4a] to-[#2a3f6a] rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full border-2 rounded-xl px-4 py-3 text-sm outline-none transition-all text-gray-800 placeholder-gray-400
          ...
          <div>
            <label className="block text-sm font-semibold text-[#1a2a4a] mb-1.5">
              Ville <span className="text-gray-400 font-normal text-xs">(optionnel)</span>
            </label>
            <input
              type="text"
              value={city}
              ...
              className="w-full border-2 border-gray-200 focus:border-[#f2994a] rounded-xl px-4 py-3 text-sm outline-none transition-all text-gray-800 placeholder-gray-400"
            />
          </div>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="w-full bg-gradient-to-r from-[#f2994a] to-[#f5af4d] text-white font-bold py-4 rounded-xl text-base shadow-lg mt-2 flex items-center justify-center gap-2"
          >
            <span>Commencer mon guide</span>
