      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16">
              ...
              <button
                ...
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium transition-all min-h-0 ${
                  currentView === id
                    ...
                    : 'text-gray-600 hover:text-[#073b4c] hover:bg-gray-100'
                }`}
              >
                <Icon size={15} />
                {label}
          ...
          <div className="hidden md:flex items-center gap-3">
            {totalXP > 0 && (
              <div className="flex items-center gap-2 bg-[#073b4c]/5 rounded-full px-3 py-1.5">
                <div className="w-5 h-5 rounded-full bg-[#8bd346] flex items-center justify-center">
                  <span className="text-[9px] font-bold text-white">XP</span>
                </div>
                <span className="text-sm font-bold text-[#073b4c]">{totalXP}</span>
          ...
          <button
            ...
            className="md:hidden p-2 rounded-lg text-[#073b4c] hover:bg-gray-100 min-h-0 min-w-0 w-10 h-10 flex items-center justify-center"
        ...
        {menuOpen && (
          ...
          >
            <nav className="max-w-6xl mx-auto px-4 py-3 flex flex-col gap-1" aria-label="Navigation mobile">
              ...
              {totalXP > 0 && (
                <div className="flex items-center gap-2 px-4 py-3 bg-[#eef9de] rounded-xl mt-1">
                  <div className="w-6 h-6 rounded-full bg-[#8bd346] flex items-center justify-center">
                    <span className="text-[10px] font-bold text-white">XP</span>
                  </div>
                  <span className="text-sm font-bold text-[#073b4c]">{totalXP} XP</span>
                  <span className="text-xs text-gray-500">· {modulesCompleted}/5 modules</span>
                </div>
              )}
            </nav>
